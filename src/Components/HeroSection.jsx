              ...
              >
                <div className="text-[#609a33] flex flex-col md:flex-row lg:flex-col md:space-x-4 lg:space-x-0">
                  ...
                  <div className="bg-white p-3 rounded-lg mb-5 shadow-md lg:max-w-[400px] w-full md:block">
                    <p className="text-[#609a33] text-base md:text-lg font-semibold">
                      Here are some of the key plant-based nutritional programs
                      to consider for maintaining a healthy body.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <button className="mt-3 w-full">
                    <Link
                      to="/enquiry-form"
                      className={`w-full px-3 md:px-12 py-3 block border-none rounded cursor-pointer text-sm md:text-base font-medium transition ease-in-out duration-300 relative overflow-hidden ${
                        isEnquiryLoading
                          ? 'loader bg-gray-500 text-white cursor-not-allowed'
                          : 'bg-[#ffa200] text-white hover:bg-[#e68a00] animate-glow'
                      }`}
